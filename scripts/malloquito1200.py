...
origin_node = 6133873484
target_node = 10923464031
costs_distribution = "lognormal"  # "uniform"
...
for c in c_values:
    for strategy, selector_class in selectors.items():
        ...
        print(
            f"Training agent with strategy: {selector.strategy} and cost distribution: {environment.costs_distribution}")
