...
from RLib.agents.ssp import QAgentSSP, QAgentSSP
...
graph = create_perceptron_graph(
    nodes_by_layer, min_length=20, max_length=60, seed=seed
)  # noqa: E501
...
save_path = os.path.join(
    RESULTS_DIR, f"Perceptron/{graph_name}/{costs_distribution}/"
)  # noqa: E501
serialize_and_save_table(
    graph_data,
    os.path.join(RESULTS_DIR, f"Perceptron/{graph_name}"),
